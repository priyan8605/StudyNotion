...
import { courseEndpoints } from "../aips"
...
//  // editCourse - update course fields (partial update) by chatgpt
...
//       if (instructions) updates.instructions = JSON.parse
//         ? JSON.parse(instructions)
//         : instructions;

//       // handle optional thumbnail image
...
// // edit the course details  =>code by me
...
export const createSection = async (data, token) => {
  ...
  try {
    ...
    // backend may return the updated course under `data`, `updatedCourse`, or `updatedCourseDetails`
    // result = response?.data?.data ?? response?.data?.updatedCourse ?? response?.data?.updatedCourseDetails
