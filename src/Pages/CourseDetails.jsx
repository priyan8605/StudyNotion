...
// fetching course details from backend on component mount and when courseId changes
  useEffect(() => {
...
// state for storing average review count of the course which is calculated using GetAvgRating utility function and is updated whenever response changes

  const [avgReviewCount, setAvgReviewCount] = useState(0)
//   calculating average review count using GetAvgRating utility function and updating avgReviewCount state whenever response changes
  useEffect(() => {
    const count = GetAvgRating(response?.data?.courseDetails.ratingsAndReviews)
          ...
          <div className="mx-auto grid min-h-[450px] max-w-maxContentTab justify-items-center py-8 lg:mx-0 lg:justify-items-start lg:py-0 xl:max-w-[810px]">
            ...
            >
              ...
              <div className="text-md flex flex-wrap items-center gap-2 lg:justify-start justify-center">
                ...
                <span>{`(${ratingsAndReviews.length} reviews)`}</span>
            ...
            <div className="flex w-full flex-col gap-4 border-y border-y-richblack-500 py-4 lg:hidden">
              ...
              <button className="yellowButton bg-yellow-50 p-6 mt-10 uppercase tracking-wider" onClick={() => handleBuyCourse()}>
                Buy Now
              </button>
