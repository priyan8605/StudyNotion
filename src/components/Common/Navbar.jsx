...
import { categories } from "../../services/aips"
...
import {IosIosArrowDropdownCircle} from 'react-icons/io'
import {RxHamburgerMenu} from "react-icons/rx"
import {IoIosArrowDown} from "react-icons/io"
import { AiOutlineMenu, AiOutlineContacts,
  AiOutlineHome,
  AiOutlineLogin, AiOutlineShoppingCart } from "react-icons/ai"
...
//  This navbar list every category in the Catalog hover (removed the filter that hid categories without courses). 
// in Category.js file in showAllCategory function we have two options to show category that has been published and that also the one which is not published.
// function Navbar() {
//   const { token } = useSelector((state) => state.auth)
//   const { user } = useSelector((state) => state.profile)
//   const { totalItems } = useSelector((state) => state.cart)
...
//                           </>
//                         ) : (
//                           <p className="text-center">No Catalog Available</p>
//                         )}
//                       </div>
//                     </div>
//                   </>
