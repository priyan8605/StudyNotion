...
//             return true;//Means form is updated
//         else
//             return false;
//     }
...
//          // when we are about to edit the course details then only make api call if form is updated
//         if(editCourse) {
//             // by default editCourse is false in courseSlice.js

//             // if form is updated then only make api call otherwise show error toast
//             if(isFormUpdated()) {
//                 const currentValues = getValues();
//             const formData = new FormData();//creating form data object to send multipart/form-data request to backend

//             //add all the fields to formData which are updated by user
//             formData.append("courseId", course._id);

//             // hum whi cheej formData me append karenge jo user ne update kari or change hui hai, taki backend pe bhi pata chale ki konse field update hua hai
//             if(currentValues.courseTitle !== course.courseName) {
//                 formData.append("courseName", data.courseTitle);
//             }
...
//         console.log("PRINTING FORMDATA", formData);
//         // now we have to send this formData to backend to create a new course
//         const result = await addCourseDetails(formData,token);
//         if(result) {
//             dispatch(setStep(2));
//             dispatch(setCourse(result));
