// ye myCourses component bss instructor ko dikhta hai 
...
export default function MyCourses() {
  ...
  useEffect(() => {
// pahle render pr api call marke instructor ke courses fetch karne hai aur uske baad jab bhi token change ho tab bhi courses ko refetch karna hai
