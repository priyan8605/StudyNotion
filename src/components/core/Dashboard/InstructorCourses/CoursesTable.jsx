...
import { Table, Tbody, Td, Th, Thead, Tr } from "react-super-responsive-table"//npm i react-super-responsive-table
...
import { formatDate } from "../../../../services/formDate.js"
import {
  deleteCourse,
      ...
      <Table className="rounded-xl border border-richblack-800">
        ...
        <Tbody>
          {courses?.length === 0 ? (
            ...
            // when courses length is greater than 0 then map through courses and show each course in
            courses?.map((course) => (
              <Tr
                key={course?._id}
              ...
              >
                ...
                <Td className="text-sm font-medium text-richblack-100 mb-1 tracking-wider uppercase">
                  {course?.courseContent?.reduce((acc, sec) => {
                    ...
                    // parseFloat() function in JavaScript parses a string argument and returns a floating-point number.
